<template>
  <el-dialog v-model="dialogVisible" title="Enter the file" width="35%" class="upload-dialog"
    :before-close="closeUpload">
    <el-upload class="upload-demo" ref="uploadRef" :on-exceed="handleExceed" drag action="http"
      :http-request="uploadHandle" :limit="1" :accept="fileAccept" v-loading="uploading">
      <el-icon :size="50">
        <UploadFilled />
      </el-icon>
      <div class="el-upload__text">
        Drag the file into here or<em>Select the file to upload</em>
      </div>
      <template #tip>
        <div class="el-upload__tip">
          Support PSD / PDF / SVG / CDR and other images and formats
        </div>
      </template>
    </el-upload>
  </el-dialog>
