<template>
  <div class="export-pdf-dialog">
    <div class="configs">
      <div class="row">
        ...
        <el-radio-group class="config-item" v-model="rangeType">
          <el-radio-button style="width: 50%;" value="all">تمامی صفحات</el-radio-button>
          <el-radio-button style="width: 50%;" value="current">صفحه کنونی</el-radio-button>
        </el-radio-group>
      </div>
      <div class="row">
        <div class="title">تعداد در هر صفحه：</div>
      ...
      <div class="row">
        <div class="title">لبه های خالی：</div>
    ...
    <div class="btns">
      <el-button class="btn export" type="primary" @click="exportPDF(rangeType)">دریافت PDF</el-button>
