<template>
  <div>
    <el-popover placement="right" trigger="click" :popper-style="{padding: 0}" width="240"
      @before-enter="setReference(true)" @hide="setReference(false)" :ref="props.referencePopoverRef"
      :virtual-ref="props.referenceRef" virtual-triggering>
      <el-row class="reference-pop-row">
        <el-col :span="8" class="reference-pop-text">Direction;</el-col>
        <el-col :span="16" class="reference-pop-direction">
          <el-radio-group v-model="direction">
            <el-radio value="vertical" size="small">Horizontal axis</el-radio>
            <el-radio value="horizontal" size="small">Vertical axis</el-radio>
          </el-radio-group>
        </el-col>
      </el-row>
      <el-row class="reference-pop-row">
        <el-col :span="6" class="reference-pop-text">Position;</el-col>
        <el-col :span="18">
      ...
      <el-row class="reference-pop-btn">
        <el-button size="small" @click="setReference(false)">Cancel</el-button>
        <el-button size="small" type="primary" @click="addReference">Okay</el-button>
      </el-row>
    </el-popover>
  </div>
</template>
