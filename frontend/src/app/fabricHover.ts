...
/**
 * After the object gets focus, a border is displayed around the periphery
 */
export class FabricHover extends Disposable {
  ...
  private drawBorderByObject(target: FabricObject) {
   ...
   //Special processing of text, display underline
    ...
    // Special processing for grouping, display rectangular border
