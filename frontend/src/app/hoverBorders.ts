...
/**
 * When an object gains focus, a border is displayed around it.
 */
export class HoverBorders extends Disposable {
  ...
  private drawBorderByObject(target: FabricObject) {
    ...
    // Special text processing, display underline
    ...
    // Special processing for groups, displaying rectangular borders
