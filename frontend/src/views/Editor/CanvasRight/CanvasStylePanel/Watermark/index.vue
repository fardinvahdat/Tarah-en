  ...
  <el-row>
    <div class="w-full">
      ...
      <el-row class="mt-[10px] w-full items-center">
        ...
        <el-col :span="19">
          <el-input class="w-320" v-model="waterMarkState.text" maxlength="15" show-word-limit type="textarea"
            autosize />
        </el-col>
      </el-row>
      ...
      <el-row class="mt-[10px] items-center">
        ...
        <el-col :span="19">
          <el-radio-group v-model="waterMarkState.position" class="w-full grid grid-cols-5 gap-1">
