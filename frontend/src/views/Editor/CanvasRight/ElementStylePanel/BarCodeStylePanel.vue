<template>
  <div class="image-style-panel">
    ...
    <el-row>
      <el-col :span="11">
        ...
        <div class="row">
          <el-popover trigger="click" width="265">
            ...
            <ColorPicker :modelValue="handleElement.codeOption.background"
      ...
      <el-col :span="2"></el-col>
      <el-col :span="11">
        <div class="title">Code color</div>
        <div class="row">
          <el-popover trigger="click" width="265">
            <template #reference>
              <ColorButton :color="handleElement.codeOption?.lineColor || '#000'" style="flex: 3" />
            </template>
            <ColorPicker :modelValue="handleElement.codeOption?.lineColor"
