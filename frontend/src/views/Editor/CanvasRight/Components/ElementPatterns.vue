<template>
  <div class="element-shadow">
    <div class="flex justify-between">
      <div style="flex: 2; "><b>Pattern</b></div>
      <div class="switch-wrapper max-w-[50px]" style="flex: 3;">
    ...
    <template v-if="props.hasPatterns">
      <div class="row">
        ...
        <el-select class="select" v-model="repeatPattern" @change="updatePatternElement">
          <el-option value="repeat" label="Repeat"></el-option>
          <el-option value="repeat-x" label=" Horizontal repeat"></el-option>
          <el-option value="repeat-y" label="Vertical repetition"></el-option>
        </el-select>
      </div>
      <div class="row">
