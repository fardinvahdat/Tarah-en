<template>
  <div class=" gap-2">
    <el-checkbox-group class="full-group flex-row-reverse !flex !justify-between gap-2 w-full" v-model="handleFlip"
      @change="changeElementFlip">
      <el-checkbox-button value="flipY" class="w-full">
        Vertical rotation
        <Icon name="vertical-flip" />
      </el-checkbox-button>
      <el-checkbox-button value="flipX" class="w-full">
        Horizontal rotation
