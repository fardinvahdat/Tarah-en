<template>
  <div>
    <div class="left-top-tabs" id="left-top-tabs">
      <div class="top-tab">
        <el-tooltip placement="top" :hide-after="0" content="The first page">
          <RouterLink to="/home">
            <Icon name="home" />
          </RouterLink>
        </el-tooltip>
      ...
      <div class="center-tabs">
        <div class="center-tab" :class="{ 'left-active': tab.key === poolType }" v-for="tab in topTabs" :key="tab.key"
          ...
          <div class="flex justify-center items-center flex-col" :id="`left-tabs-${tab.key}`">
            <Icon :name="tab.icon" :color="tab.key === poolType ? '#e2ebfe' : '#000000'" />
...
const topTabs: TabItem[] = [
  ...
  { key: "template", label: "Mold", icon: `template`, index: 1 },
  { key: "material", label: "Figure", icon: `material`, index: 2 },
