<template>
  <div>
    <el-popover placement="right" trigger="click" :popper-style="{ padding: 0 }" @before-enter="setHelp(true)"
      @hide="setHelp(false)" :ref="props.helpPopoverRef" :virtual-ref="props.helpRef" virtual-triggering>
      <!-- <el-row class="help-pop-row">
        <IconGuideBoard class="help-pop-icon" />
        <span class="help-pop-text">Beginner's Guide</span>
      </el-row>
      <el-row class="help-pop-row">
        <IconVideoTwo class="help-pop-icon" />
        <span class="help-pop-text">User Guide</span>
      </el-row>
      <el-row class="help-pop-row" @click="hasHotkey = true">
        <IconKeyboardOne class="help-pop-icon" />
        <span class="help-pop-text">Shortcuts</span>
      </el-row>
      <el-row class="help-pop-row">
        <IconEdit class="help-pop-icon" />
        <span class="help-pop-text">Suggestions</span>
      </el-row>
      <el-row class="help-pop-row">
