<template>
  <div>
    <el-row class="layout-search">
      <el-input :prefix-icon="Search" placeholder="جستجوی ابزار"></el-input>
    </el-row>
    <el-row>
      <el-row class="code-common" @click="openUseGPT">
        ...
        <el-col :span="20" class="code-text">
          <div class="font-middle">ChatGPT-4 را باز کنید</div>
          <div class="font-little">برای باز کردن ChatGPT-4 با من تماس بگیرید</div>
        </el-col>
      </el-row>
    </el-row>
    <el-row>
...
const openUseGPT = debounce(function() {
  ElMessageBox.alert('Function is under development, please stay tuned', 'hint', {
