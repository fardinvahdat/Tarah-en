  ...
  <div class="layout-pool">
    <div class="code-content">
      ...
      <el-carousel type="card" height="135px" :autoplay="false" trigger="click" indicator-position="none">
        <el-carousel-item v-for="item in [...QRCodeOptionsLibs, ...QRCodeDotsOptionsLibs, ...QRCodeCornersOptionsLibs]"
          :key="item">
      ...
      <div class="row">
        <el-radio-group class="full-ratio" v-model="codeSpace" @change="updateCodeSpace">
          <el-radio-button :value="true" :label="true">No distance</el-radio-button>
          <el-radio-button :value="false" :label="false">Standard distance</el-radio-button>
        </el-radio-group>
      </div>
...
import { QRCodeOptionsLibs, QRCodeDotsOptionsLibs, QRCodeCornersOptionsLibs } from '@/configs/codeStyles'
import { 
  encodeData,
  renderer25D,
  rendererRect,
...
// Modify the fault tolerance rate
