<template>
  <div>
    <el-affix position="bottom" :offset="25" v-show="unitMode === 0" style="width: calc(100%)">
      <el-checkbox-group class="flex-row-reverse" v-model="showWorkLines" @change="changeWorkLines">
        <el-tooltip placement="top" :hide-after="0" :content="(showSafe ? 'Show safe line' : 'Hiding the safe line')">
          <el-checkbox-button type="primary" class="safe-btn" value="safe" :checked="showSafe">
            <!-- <IconShield /> -->
          </el-checkbox-button>
        </el-tooltip>
        <el-tooltip placement="top" :hide-after="0" content="Establishing canvas">
          <el-checkbox-button type="primary" value="drag" :checked="isDrag">
            <!-- <IconClickTap /> -->
          </el-checkbox-button>
        </el-tooltip>
        <el-tooltip placement="top" :hide-after="0" :content="(showClip ? 'Hiding the blood line' : 'Show the blood line')">
