<template>
    <div v-if="user.workspaces?.length" class="workspaces-container">
        <div class="section-header">
            <h1 class="section-title">طراحی های اخیر</h1>
            <div class="section-line"></div>
        </div>

        <ul class="workspaces-grid">
            <li v-for="(item, index) in user.workspaces" :key="index" @click="handleCickWorkspace(item)"
                class="workspace-item" :style="{ animationDelay: `${index * 0.1}s` }">
