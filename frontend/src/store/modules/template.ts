...
import { FabricObject, SerializedImageProps, FabricImage } from 'fabric'
...
export const useTemplatesStore = defineStore("Templates", {
  ...
  actions: {
    ...
    async modifedElement(target: FabricObject, options: Record<string, any>) {
      const [canvas] = useCanvas();
